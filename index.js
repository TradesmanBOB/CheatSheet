...
function updateSidePanel(section) {
    ...
    if (section === '') {
        ...
        <p>This page is scrollable. Select one of the colored languages, and you will see
        an explanation and example as to what each language does and how they are used.</p>`;
    } else {
